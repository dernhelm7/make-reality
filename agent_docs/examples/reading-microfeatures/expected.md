...
- The home contents row for `Garden Path` places `Garden Path` at the left, a baseline dotted leader in the middle, and `garden-path` at the right like a page reference.
