...
I'd like to make that happen. The first step is to make feeds easy to use. More to come: in the meantime I recommend you start with [_About Feeds._](https://aboutfeeds.com/)

Human readable feed layout inspired by [_Don't kill my pretty RSS feed._](https://justinjackson.ca/xslt)
