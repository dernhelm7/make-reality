...
class AcceptanceTests(FixtureSiteTestCase):
    ...
    def test_minimal_markdown_fixture(self) -> None:
        ...
        self.assertIn('<h2 class="page-title page-title--section" id="contents-heading"><a class="home-contents-heading-link" href="#read-index"><span>Read</span><span class="home-contents-heading-arrow" aria-hidden="true">&rarr;</span></a></h2>', home_page)
        self.assertIn('<div class="page-body works-body" id="read-index">', home_page)
    ...
    def test_starter_site_uses_make_reality_sections_and_write_link(self) -> None:
        ...
        self.assertIn('href="#read-index"><span>Read</span><span class="home-contents-heading-arrow" aria-hidden="true">&rarr;</span></a></h2>', home_page)
        ...
        self.assertIn(">Projects</h3>", home_page)
        self.assertIn(">Cabinet</h3>", home_page)
        self.assertIn("the stuff of reality", home_page)
        self.assertIn("how I&#x27;ve solved problems", home_page)
        self.assertIn('class="site-link site-link--preview" href="https://tally.so/r/7RJ6Z2" data-site-preview-trigger="write"', home_page)
        self.assertIn(
        ...
        self.assertIn("link.addEventListener('pointerenter', clear);", home_page)
        self.assertIn(".site-link-preview-panel", stylesheet)
        self.assertIn(".site-link-preview-panel--text", stylesheet)
        self.assertIn("--link-preview-max-width: var(--home-column-measure);", stylesheet)
        self.assertIn("--link-preview-viewport-width: calc(100vw - (var(--link-preview-side-space) * 2) - var(--home-column-measure) - var(--page-column-gap));", stylesheet)
        self.assertIn("--link-preview-width: min(var(--link-preview-max-width), var(--link-preview-track-width), var(--link-preview-viewport-width));", stylesheet)
        self.assertIn("--link-preview-title-x-height-offset: calc(var(--page-title-display-size) * 0.22);", stylesheet)
        self.assertIn("--link-preview-height:", stylesheet)
        self.assertIn("--link-preview-top: calc(var(--cover-top-space) + var(--link-preview-title-x-height-offset));", stylesheet)
        self.assertIn("--read-fold-cue-space: calc((var(--page-title-section-size) * var(--leading-tight)) + var(--home-stack-gap) - var(--site-bottom-space) + (var(--page-stack-gap) / 2));", stylesheet)
        self.assertIn(".home-contents-heading-arrow", stylesheet)
        self.assertIn(".site-page--home .page--cover {\n  position: relative;", stylesheet)
